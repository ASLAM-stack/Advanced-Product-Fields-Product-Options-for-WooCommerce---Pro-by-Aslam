<?php
/**
 * Frontend Template: Single-line Text Field.
 *
 * @package APF_Aslam
 */
...
<div class="apf-field-wrap apf-type-text" id="apf-wrap-<?php echo esc_attr( $id ); ?>" data-field-id="<?php echo esc_attr( $id ); ?>" data-field-type="text" data-pricing-type="<?php echo esc_attr( $p_type ); ?>" data-pricing-amount="<?php echo esc_attr( $p_amount ); ?>" data-free-chars="<?php echo esc_attr( $field['free_characters'] ?? 0 ); ?>" data-conditions="<?php echo esc_attr( wp_json_encode( $field['conditional_logic'] ?? array() ) ); ?>">
	...
	<div class="apf-input-wrapper">
		<input 
			...
			class="apf-input apf-text-input" 
